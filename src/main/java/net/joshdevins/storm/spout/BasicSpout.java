...
/**
 * An default implementation if {@link IRichSpout} leaving basic methods empty. This will also save the collector that is set on {@link #open(Map, TopologyContext, SpoutOutputCollector)} and call a
 * simpler {@link #open()} method on sub-classes as a convenience/simplification.
 * 
 * @author Josh Devins
 */
